...
def city_page(user_city):
    try:
        ...
        if uk_defra_index > 6 and logged_in == True:
            flash("Important Air Quality Advice Below!")
        ...
        with sqlite3.connect(r"C:\Users\738290\Downloads\SQLiteDatabaseBrowserPortable\WeatherAppDB.db") as conn:
            ...
            for user in users:
                ...
                if db_email == entered_email and equal_passwords:
                    flash(f"Hello, {db_name}, you are now logged in!")
                    logged_in = True
                    user_name = db_name
                    return redirect("/")
        ...
        with sqlite3.connect(r"C:\Users\738290\Downloads\SQLiteDatabaseBrowserPortable\WeatherAppDB.db") as conn:
            ...
            for user in users:
                ...
                if db_email == user_email:
                    flash("Please try with a different email address!")
...
def accessibility_page():
    if request.method == "POST":
        ...
        flash("Accessibility Settings Updated")
        return render_template("home.html", font_size=font_size, background_color=background_color,
