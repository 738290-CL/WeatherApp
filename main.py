...
def city_page(user_city):
    try:
        ...
        print(fdata["forecast"]["forecastday"][0])  # testing-----------------------------------------------------------
        ...
        return render_template("home.html", placeholder="Please enter a valid City name!", logged_in=logged_in) \
               and redirect("/")
    ...
    if request.method == "POST":
        ...
        with sqlite3.connect(r"C:\Users\738290\Downloads\SQLiteDatabaseBrowserPortable\WeatherAppDB.db") as conn:
            ...
            for user in users:
                ...
                # print("testing dbpw:", db_password)
                ...
                # print("testing equal password:", equal_passwords)  # testing -----------------------------------------

                if db_email == entered_email and equal_passwords:
                    logged_in = True
                    user_name = db_name
                    # print("logged_in test:", logged_in)
                    return redirect("/")
            # else
            logged_in = False
            # print("logged_in test:", logged_in)
